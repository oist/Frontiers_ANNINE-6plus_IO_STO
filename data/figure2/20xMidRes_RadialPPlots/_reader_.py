...
ax8.scatter(MEAN_INSIDE_D0, MEAN_OUTSIDE_D0, facecolor='white', edgecolor='blue', alpha=0.3)
ax9.scatter(MEAN_INSIDE_D1, MEAN_OUTSIDE_D1, facecolor='white', edgecolor='purple', alpha=0.3)
ax10.scatter(MEAN_INSIDE_D7, MEAN_OUTSIDE_D7, facecolor='white', edgecolor='orange', alpha=0.3)

ax8.plot((0,1),(0,1), ls='--', lw=1, color='black')
ax9.plot((0,1),(0,1), ls='--', lw=1, color='black')
ax10.plot((0,1),(0,1), ls='--', lw=1, color='black')

ax1.set_xlabel('Radial distance (um)')
ax1.set_ylabel('Normalized Di4 intensity')
ax2.set_xlabel('Radial distance (um)')
ax2.set_ylabel('Normalized Di4 intensity')
ax3.set_xlabel('Radial distance (um)')
ax3.set_ylabel('Normalized Di4 intensity')
ax4.set_ylabel('Average Di4 intensity per cell')
ax4.set_xlabel('Days post-injection')
ax7.set_ylabel('% Internalized Di4')
ax7.set_xlabel('Day post-injection')
ax8.set_xlabel('Internalized Di4')
ax8.set_ylabel('Non-internalized Di4')
ax9.set_xlabel('Internalized Di4')
ax9.set_ylabel('Non-internalized Di4')
ax10.set_xlabel('Internalized Di4')
ax10.set_ylabel('Non-internalized Di4')
plt.tight_layout()
